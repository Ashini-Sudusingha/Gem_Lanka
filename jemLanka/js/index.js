async function loadProductData() {
    ...
    const response = await fetch("http://localhost:8080/JemLankaBackEnd/Home");
    if (response.ok) {
        ...
        let product_card = `    
                    <div
                        ...
                        <div class="w-full h-56">
                            <a href="single-product.html?id=${item.id}">
                                <img class="h-full mx-auto rounded-4xl"
                                    src="productImage/${item.id}/image1.png" />
                        ...
                        <div class="pt-6">
                            ...
                            <a href="#"
                                class="text-lg font-semibold leading-tight text-gray-900 hover:underline ">${item.title}
                              </a>
                            ...
                            <div class="flex items-center justify-between gap-4 mt-4">
                                <p class="text-2xl font-extrabold leading-tight text-gray-900 ">$. ${new Intl.NumberFormat(
            "en-US",
            { minimumFractionDigits: 0 })
                .format(item.price)}
                                ...
                                <button type="button"
                                    class="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-mediumhover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 ">
