                            ...
                            if (treatment == null) {
                                ...
                                if (status == null) {
                                    ...
                                    if (checkuser.getEmail().equals(u1.getEmail())) {
                                        ...
                                        //image save part
                                        // External path (xampp htdocs folder)
                                      
                                         String basePath = "D:" + File.separator + "XamppNewFolder" + File.separator + "htdocs" + File.separator + "jemLanka" + File.separator + "productImage";
                                        String productId = String.valueOf(id);

                                        File productFolder = new File(basePath, productId);

                                        System.out.println("methanata enava ");
