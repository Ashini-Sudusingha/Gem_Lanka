...
public class CheckOut extends HttpServlet {
 private Gson gson = new Gson();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean termscheckbox = requJsonObject.get("termscheckbox").getAsBoolean();
        int addressId = requJsonObject.get("addressSelected").getAsInt();
    ...
    private void processCheckout(Session s,
        ...
        try {
            ...
            payHereJson.addProperty("notify_url", " https://3bf5dc2192c0.ngrok-free.app/JemLankaBackEnd/VerifyPayments");
            ...
            responseObject.add("orderId", gson.toJsonTree(orderID));
             responseObject.add("address", gson.toJsonTree(address));
              responseObject.add("amount", gson.toJsonTree(amount));
            responseObject.addProperty("message", "Cechkout completed");
