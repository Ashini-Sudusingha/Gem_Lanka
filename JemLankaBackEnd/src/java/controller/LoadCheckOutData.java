    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (sessionUser == null) {
            ...
            if (c1.list().isEmpty()) {
                ...
                address1.getUser().setPassword(null);
                address1.getUser().setVerification(null);
                address1.getUser().setId(-1);
                address1.getUser().setCreated_at(null);
                responseObject.addProperty("status", true);
                }
                // retrive user first name and last name
             
                responseObject.add("userAddress", gson.toJsonTree(addressList));
            }
           ...
           //  get user carts
            ...
            if (cartList.isEmpty()) {
                ...
                for (Cart cart : cartList) {
                    ...
                    cart.getProduct().getStore().setUser(null); // ignore seller information
                }
